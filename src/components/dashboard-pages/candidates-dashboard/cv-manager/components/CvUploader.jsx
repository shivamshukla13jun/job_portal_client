...
const CvUploader = ({ getManager, setManager }) => {
    ...
    const deleteHandler = (name) => {
        const deleted = getManager?.filter((file) => (file.name || file.originalname) !== name);
        setManager(deleted);
    };
            ...
            <div className="uploading-resume">
                <div className="uploadButton">
                    ...
                    <label className="cv-uploadButton" htmlFor="upload">
                        ...
                        <span className="text">
                            To upload file size is (Max 10Mb overall) and allowed file
            ...
            <div className="files-outer">
                {getManager?.map((file, i) => (
                    <div key={i} className="file-edit-box">
                        <span className="title">{file.name || file.originalname}</span>
                        <div className="edit-btns">
                            {/* <button>
                                <span className="la la-pencil"></span>
                            </button> */}
                            <button onClick={() => deleteHandler(file?.name ? file.name : file.originalname)}>
