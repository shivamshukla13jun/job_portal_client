        ...
        <div className='default-form'>
            <div className='row'>
                ...
                <div className='form-group col-lg-6 col-md-12'>
                    ...
                    <select className={`${error?.company?.vacancy?.message ? 'error' : ''}`} {...register("company.vacancy")}>
                        <option value={""} hidden>Select an option</option>
                        <option value={"Once in year"}>Once in year</option>
                        <option value={"Once in a few months"}>Once in a few months</option>
                        <option value={"Once or twice every month"}>Once or twice every month</option>
                        <option value={"Hiring new people everyday"}>Hiring new people everyday</option>
                    </select>
                </div>
            </div>
        </div>
